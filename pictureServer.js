...
function takePicture() {
    ...
    console.log('Capturing a picture at ' + imageName + '.jpg'); // Second, the name is logged to the console.
...
function transmitImageNames() {
    io.emit('newGif', imageNames);
}
...
io.on('connect', function (socket) {
    // Timer responsible for taking pictures with the camera.
    var cameraTimer;
    ...
    // Start recording images at a fixed interval.
    socket.on('startRecording', function() {
        console.log('[SERVER] Recording...');
        imageNames = [];
